                      ...
                      function onResults(results) {
                        ...
                        // Trigger animation after collecting data for 5 seconds
                        if (!animationTriggered && trackedPositions.length > 0) {
                          setTimeout(() => {
                            animationTriggered = true;
                            generateCSSAnimation();
                          }, 5000); // Trigger animation after 5 seconds of data collection
                        }
                      }
